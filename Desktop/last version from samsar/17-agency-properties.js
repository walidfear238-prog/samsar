 ...
 function render(filter){
  ...
  body.innerHTML=arr.map(p=>`
   <tr data-id="${p.id}">
    ...
    <td><div class="row-actions"><a class="r-btn r-btn-text" href="03-property-details.html" title="View">View</a><a class="r-btn r-btn-text edit" href="19-agency-edit-property.html" title="Edit">Edit</a><button class="r-btn danger" data-del="${p.id}" title="Delete">✕</button></div></td>
   </tr>`).join('');
