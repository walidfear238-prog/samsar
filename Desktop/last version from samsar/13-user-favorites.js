  ...
  <article class="fav-card" style="transition-delay:${i*60}ms">
   <div class="fav-img">
    ...
    <div class="fav-tools">
     ...
     <a class="f-icon" href="15-user-messages.html" aria-label="Message">✉</a>
    </div>
   </div>
   <div class="fav-body">
    <span class="fav-loc">${p.l}</span>
    <h3 class="fav-title"><a href="03-property-details.html">${p.t}</a></h3>
    <div class="fav-specs"><span>${p.b} bd</span><span>${p.ba} ba</span><span>${p.a} m²</span></div>
    <div class="fav-foot"><span class="fav-price">${p.p} <small>${p.u}</small></span><a href="03-property-details.html" style="color:var(--crimson);font-size:13px;font-weight:500">View →</a></div>
