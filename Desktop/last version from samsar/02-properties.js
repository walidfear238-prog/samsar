  ...
  grid.innerHTML = list.map((p,i) => `
   <article class="card is-in" style="transition-delay:${i*45}ms">
    ...
    <div class="card-body">
     ...
     <h3 class="card-title"><a href="03-property-details.html">${p.t}</a></h3>
     <div class="card-specs"><span>${p.b} bd</span><span>${p.ba} ba</span><span>${p.a} m²</span></div>
     <div class="card-foot"><span class="card-price">${p.p} <small>${p.u}</small></span><a class="view-details" href="03-property-details.html">View details <span class="arrow">→</span></a></div>
    </div>
